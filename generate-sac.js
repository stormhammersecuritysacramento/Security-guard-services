...
<body class="bg-zinc-950 text-zinc-100 min-h-screen flex items-center justify-center p-4 antialiased">
    <div class="max-w-lg w-full bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 md:p-8 space-y-6">
        ...
        <!-- Premium Minimalist Text Header -->
        <div class="flex flex-col items-center text-center space-y-2 border-b border-zinc-800 pb-4">
            <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-500/20 mb-1">
            ...
            <div class="inline-block bg-amber-500/10 border border-amber-500/30 text-amber-400 font-mono text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">
                Sacramento Regional Dispatch — Zone: ${item.district} (Zip ${item.zip})
            </div>
        </div>

        <!-- Main Copy Content Block -->
        <div class="space-y-4">
...
console.log("Sacramento local campaigns built cleanly with high-conversion text-only formatting.");
